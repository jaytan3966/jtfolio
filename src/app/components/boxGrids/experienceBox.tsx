...
export default function ExperienceBox(){
    ...
    return (
        <div ref={ref} className={`box-border border-4 rounded-sm max-w-[50vw] ${isDarkMode ? "border-white" : "border-black"} ${isTransitioning ? 'opacity-0 scale-95' : 'opacity-100 scale-100'} transition-all duration-600`}>
            ...
            <div className="mx-3 my-2 font-bold flex items-end text-center">
                <h1 className="text-lg md:text-xl mr-1 md:mr-2">{"<"}Nyan Shibar title="Sensei"{">"}</h1>
            </div>

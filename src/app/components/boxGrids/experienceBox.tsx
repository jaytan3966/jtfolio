        ...
        >
            <Link 
                ...
                <div className="relative">
                    ...
                    <div className={`aspect-video w-full overflow-hidden flex items-center justify-center p-6 ${isDarkMode ? "bg-white" : "bg-gray-100"}`}>
                        <Image
                            title={`View ${name}`}
                            width={500}
                            height={300}
                            src={`${img}`}
                            className="max-w-full max-h-full object-contain group-hover:opacity-30 hover:cursor-pointer transition-all duration-500"
                            alt={name}
                        />
                    </div>
            ...
            <div className="flex-grow flex flex-col p-2">
                ...
                <div className="flex-grow min-h-[60px] my-2 overflow-y-auto">
                    <p className={`text-center mb-2 mx-2 ${isDarkMode ? "text-gray-400" : "text-gray-600"} transition-all duration-500`}>{description == "" ? "Starting soon!" : description}</p>
                </div>
